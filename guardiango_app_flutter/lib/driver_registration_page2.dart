...
class DriverRegistrationPage2 extends StatefulWidget {
  ...
  const DriverRegistrationPage2(
      {super.key, required this.pageController, required this.onNext});

  @override
  State<DriverRegistrationPage2> createState() =>
      _DriverRegistrationPage2State();
}
                  ...
                  _buildSectionContainer(
                    child: Column(
                      ...
                      children: [
                        ...
                        const Text(
                            "Upload clear photos of your bus (exterior and interior)",
                  ...
                  _buildSectionContainer(
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildTextField(
                            _modelController, "e.g., Nissan Civilian", null),
                        ...
                        _buildTextField(_plateNumberController,
                            "e.g., ABC-1234", Icons.tag),
                        const SizedBox(height: 15),
                        _buildLabel("Number of Seats"),
                        _buildTextField(
                            _seatsController, "e.g., 45", Icons.person_outline),
                      ],
                    ),
                  ),
                  const SizedBox(height: 20),
                  ...
                  _buildSectionContainer(
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 8),
                        _buildTextField(_otherFeaturesController,
                            "Add your Vehicle Features", null),
                      ],
                    ),
                  ),
  ...
  Widget _buildActionButtons() {
    return SizedBox(
      ...
      child: ElevatedButton(
        ...
        child: const Text("Continue to Route Details",
            style: TextStyle(fontWeight: FontWeight.bold)),
      ),
    );
  }
