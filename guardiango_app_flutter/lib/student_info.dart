...
import 'package:flutter/services.dart'; // this for Clipboard
import 'package:url_launcher/url_launcher.dart'; // this for Calling
      ...
      child: _buildInfoContainer(
        child: Column(
          children: [
              ...
              children: [
                ...
                const Column(
                  ...
                  children: [
                    ...
                    Text("Student ID: SE2024001",
                        style: TextStyle(color: Colors.grey, fontSize: 12)),
                    SizedBox(height: 5),
                    Chip(
                        label: Text("Grade 5A", style: TextStyle(fontSize: 10)),
            ...
            _buildDataRow("Date of Birth", "3/15/2014", "School",
                "Sunshine Elementary School"),
            _buildDataRow("Grade", "5th Grade", "Class", "Grade 5A"),
            _buildDataRow("Room Number", "Room 205", "", ""),
            const Divider(),
            _buildLongData(
                "Home Address", "123 Maple Street, Springfield, IL 62701"),
            const Divider(),
            _buildLongData("Parent Notes",
                "Emma gets nervous in new situations. Please give her a few extra minutes to adjust."),
          ],
        ),
      ),
    );
      ...
      child: _buildInfoContainer(
        child: Column(
          ...
          children: [
            ...
            _buildDataRow("Blood Type", "A+", "Insurance Provider",
                "Blue Cross Blue Shield"),
            _buildDataRow("Policy Number", "BC123456789", "", ""),
            const Divider(),
            _buildDataRow("Primary Physician", "Dr. Sarah Mitchell",
                "Physician Phone", "(555) 123-9876"),
            const Divider(),
            const Text("Allergies",
                style: TextStyle(fontWeight: FontWeight.bold, fontSize: 13)),
            Row(children: [
              _buildTag("Peanuts", Colors.red),
              _buildTag("Tree nuts", Colors.red)
            ]),
            const SizedBox(height: 15),
            const Text("Current Medications",
                style: TextStyle(fontWeight: FontWeight.bold, fontSize: 13)),
            Row(children: [
              _buildTag("EpiPen Jr.", Colors.grey.shade200),
              _buildTag("Albuterol inhaler", Colors.grey.shade200)
            ]),
            const SizedBox(height: 15),
            const Text("Medical Conditions",
                style: TextStyle(fontWeight: FontWeight.bold, fontSize: 13)),
            Row(children: [
              _buildTag("Asthma", Colors.grey.shade300),
              _buildTag("Food allergies", Colors.grey.shade300)
            ]),
            const SizedBox(height: 15),
            _buildLongData("Special Needs & Instructions",
                "Requires inhaler during physical activities"),
            const SizedBox(height: 15),
            const Text("Dietary Restrictions",
                style: TextStyle(fontWeight: FontWeight.bold, fontSize: 13)),
            Row(children: [
              _buildTag("Nut-free", Colors.grey.shade100),
              _buildTag("Shellfish-free", Colors.grey.shade100)
            ]),
          ],
        ),
      ),
      ...
      child: _buildInfoContainer(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 15),
            _buildContactCard("Sarah Johnson", "Mother", "(555) 123-9876",
                "sarah.j@email.com",
                isPrimary: true),
            _buildContactCard(
                "Mike Johnson", "Father", "(555) 987-6543", "mike.j@email.com"),
            _buildContactCard("Linda Martinez", "Grandmother", "(555) 456-7890",
                "linda.m@email.com"),
          ],
        ),
      ),
          ...
          _buildInfoContainer(
            child: Column(
              ...
              children: [
                const Row(
                  children: [
                    Icon(Icons.directions_bus_outlined, color: Colors.blue),
                    SizedBox(width: 8),
                ...
                const SizedBox(height: 20),
                _buildDataRow(
                    "Bus Route", "Route A-42", "Pickup Time", "7.45 AM"),
            ...
            children: [
              Expanded(
                  child: _buildIconButton(
                      Icons.calendar_month_outlined, "View Attendance")),
              const SizedBox(width: 10),
          ...
          children: [
            ...
            Container(
                ...
                decoration: BoxDecoration(
                    color: Colors.grey.shade200,
                    borderRadius: BorderRadius.circular(5)),
                child: const Text("Authorized Pickup",
